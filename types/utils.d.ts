...
export declare function deepCloneSimple<T>(v: Partial<T>): T;
...
export declare function findTemplate<T>(this: void, selection: _ISelection, t: _Transaction, template?: Partial<T>, columns?: (keyof T)[]): Iterable<T>;

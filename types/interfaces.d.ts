...
export declare type QueryInterceptor = (query: string) => any[] | nil;
export declare type ArgDef = DataType | IType | ArgDefDetails;
...
export declare type LanguageCompiler = (options: ToCompile) => CompiledFunction;
...
export declare type CompiledFunction = (...inArguments: any[]) => AdvancedResult | PlainResult;
export declare type PlainResult = Object | number | Date | null | void;
...
export declare type QueryOrAst = string | Statement | Statement[];

import { IMemoryDb, IMemoryTable, DataType, IType, TableEvent, GlobalEvent, ISchema, SchemaField, MemoryDbOptions, nil, Schema, ISubscription, LanguageCompiler, ArgDefDetails, QueryResult } from './interfaces';
...
export declare type RegClass = string | number;
export declare type RegType = string | number;
export declare type TypeQuery = DataTypeDef | DataType | number | _IType;
...
export declare type OnStatementExecuted = (t: _Transaction) => void;
...
export declare type _ArgDefDetails = ArgDefDetails & {
    type: _IType;
    default?: IValue;
};
...
export declare type _SelectExplanation = {
    /** A jointure */
    id: string | number;
    _: 'join';
...
export declare type _IndexExplanation = {
...
export declare type _ExprExplanation = {
    constant: true;
} | {
...
export declare type DropHandler = (t: _Transaction, cascade: boolean) => void;
export declare type TruncateHandler = (t: _Transaction, opts: TruncateOpts) => void;
export declare type IndexHandler = (act: 'create' | 'drop', idx: _INamedIndex) => void;
...
export declare type ChangeHandler<T = any> = (old: T | null, neu: T | null, t: _Transaction, opts: ChangeOpts) => void;
...
export declare type IndexKey = unknown[];
...
export declare type TR<T> = Record<TableRecordDef<T>>;
export declare type CR<T> = Record<TableColumnRecordDef<T>>;
export declare const EmtpyTable: Record.Factory<TableRecordDef<any>>;
export declare const NewColumn: Record.Factory<TableColumnRecordDef<any>>;
export declare type _IRelation = _ITable | _ISequence | _INamedIndex | _IType | _IView;
...
export declare type _ISelectable = _ITable | _IView;
